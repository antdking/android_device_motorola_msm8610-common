...
for FILE in `egrep -v '(^#|^$)' ../$DEVICE/device-proprietary-files.txt`; do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ] && [ -f ../$COMMON_NAME/proprietary-files.txt ]; then
    LINEEND=" \\"
  elif [ $COUNT = "0" ]; then
  LINEEND=""
  fi
...
LINEEND=" \\"
COUNT=`wc -l ../$COMMON_NAME/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../$COMMON_NAME/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
...
\$(call inherit-product, vendor/motorola/$COMMON_NAME/$COMMON_NAME-vendor.mk)
...
echo "PRODUCT_PACKAGES += $privmodulename" >> ../../../$OUTDIR/$DEVICE-vendor.mk
done
echo "endif" >> ../../../${OUTDIR}/proprietary/priv-app/Android.mk
fi

export DEVICE=$COMMON_NAME
OUTDIR=vendor/$VENDOR/$DEVICE
MAKEFILE=../../../$OUTDIR/$DEVICE-vendor-blobs.mk
...
LINEEND=" \\"
COUNT=`wc -l ../$COMMON_NAME/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../$COMMON_NAME/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
...
echo "ifeq (\$(TARGET_BOARD_PLATFORM),msm8610)" >> ../../../${OUTDIR}/proprietary/app/Android.mk
echo ""  >> ../../../${OUTDIR}/proprietary/app/Android.mk
...
echo "ifeq (\$(TARGET_BOARD_PLATFORM),msm8610)" >> ../../../${OUTDIR}/proprietary/framework/Android.mk
echo ""  >> ../../../${OUTDIR}/proprietary/framework/Android.mk
...
echo "ifeq (\$(BOARD_VENDOR),motorola-qcom)" >> ../../../${OUTDIR}/proprietary/priv-app/Android.mk
echo "ifeq (\$(TARGET_BOARD_PLATFORM),msm8610)" >> ../../../${OUTDIR}/proprietary/priv-app/Android.mk
echo ""  >> ../../../${OUTDIR}/proprietary/priv-app/Android.mk
